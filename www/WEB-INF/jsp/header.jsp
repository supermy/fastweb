...
<div id="top1">
	用户 <a href="register.do" >注册</a> <a href="login.do" >登陆</a> <a href="userManager.do" >管理</a>    <p id="toggle"><a href="#" id="tRight">右</a><a href="#" id="tLeft">左</a><a href="#" id="closeLeft">左隐</a><a href="#" id="padRight">宽线</a></p>
</div>
<div id="top2">
	错误信息：${errors}
</div>
