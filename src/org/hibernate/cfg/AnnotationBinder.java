...
public final class AnnotationBinder {
	...
	public static void bindClass(
		...
		if ( annotatedClass.isAnnotationPresent( Comment.class ) ) {
				    Comment commentAnn = annotatedClass.getAnnotation( Comment.class );
			    comment = commentAnn.value()+(commentAnn.desc().isEmpty()?"":" desc:" +commentAnn.desc());
			}     		
		...
		if ( comment != null ) {
	           if ( joinColumns != null ) {
	               for ( Ejb3Column column : joinColumns ) {
	            	   column.setComment( comment.value()+(comment.desc().isEmpty()?"":" desc:" +comment.desc()));
	               }
	           }
	           else {
