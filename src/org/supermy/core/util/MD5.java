...
public class MD5 {
	...
	public static void main(String args[]) {
		 ...
		 * 
		 * log.debug("MD5 Test suite:");
		 * log.debug("MD5(\"\"):" + m.getMD5ofStr(""));
		 * log.debug("MD5(\"a\"):" + m.getMD5ofStr("a"));
		 * log.debug("MD5(\"abc\"):" + m.getMD5ofStr("abc"));
		 * log.debug( "MD5(\"message digest\"):" +
		 * m.getMD5ofStr("message digest")); log.debug(
		 * "MD5(\"abcdefghijklmnopqrstuvwxyz\"):" +
		 * m.getMD5ofStr("abcdefghijklmnopqrstuvwxyz")); log.debug(
		 * "MD5(\"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789\"):" +
		 * m.getMD5ofStr(
		 * "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789")); }
		 * else log.debug( "MD5(" + args[0] + ")=" +
