...
/**
 */
public class BasePackageExporter extends GenericExporter {
	...
	protected String resolveFilename(POJOClass element) {
		String filename = StringHelper.replace(super.getFilePattern(), "{class-name}", getClassNameForFile( element )); 
